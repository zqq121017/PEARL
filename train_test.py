...
def prepare_trte_data(data_folder, view_list):
    ...
    for i in range(len(data_mat_list)):
        data_tensor_list.append(torch.FloatTensor(data_mat_list[i]).to(device))
    idx_dict = {}
...
def gen_trte_adj_mat(data_tr_list, data_trte_list, trte_idx, adj_parameter):
    ...
    for i in range(len(data_tr_list)):
        ...
        adj_train_list.append(gen_adj_mat_tensor(data_tr_list[i], adj_parameter_adaptive))
        adj_test_list.append(gen_test_adj_mat_tensor(data_trte_list[i], trte_idx, adj_parameter_adaptive))
...
def train_test(data_folder, view_list, num_class,
    ...
    if data_folder == 'ROSMAP':
        ...
        raise ValueError("Unsupported data folder")
